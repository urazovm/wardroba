...
public class ProductGallery1 extends FragmentActivity
{
		...
		public void setResponseFromRequest(Object obj)
		{
			if(obj!=null)
			{
				...
				Toast.makeText(ProductGallery1.this, "Product found:"+arr_productGallery.size(), Toast.LENGTH_SHORT).show();
				
				gridView.setAdapter(new ProductGalleryAdapter(ProductGallery1.this));
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
   	 ...
   	 /*try {
			WebAPIHelper webAPIHelper=new WebAPIHelper(Constants.search_list, ProductGallery1.this, "Please wait...");
