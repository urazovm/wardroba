...
{	
	...
	//http://dev.wardroba.com/api-update-password?id=15&password=nilesh&cpassword=nilesh
	...
	public final static int profile_owner_list = 69;
	public final static int edit_profile = 70;
